                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        name="name" id="inputName" type="text" placeholder="Enter your name" required/>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary w-100" type="submit">Create Account</button></div>
                                            </div>
                                        </form>
                                    </div>
